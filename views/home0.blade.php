            ...
            <div class="header_content d-flex flex-row align-items-center justify-content-start">
                ...
                <div class="header_extra ml-auto d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="info_languages has_children">
                        <div class="language_flag"><img src="{{asset('images')}}/flag_1.svg" alt="https://www.flaticon.com/authors/freepik"></div>
                        ...
                        <ul>
                            <li><a href="#">
                                <div class="language_flag"><img src="{{asset('images')}}/flag_2.svg" alt="https://www.flaticon.com/authors/freepik"></div>
                                <div class="dropdown_text">french</div>
                            </a></li>
                            <li><a href="#">
                                <div class="language_flag"><img src="{{asset('images')}}/flag_3.svg" alt="https://www.flaticon.com/authors/freepik"></div>
                                <div class="dropdown_text">japanese</div>
                            </a></li>
                            <li><a href="#">
                                <div class="language_flag"><img src="{{asset('images')}}/flag_4.svg" alt="https://www.flaticon.com/authors/freepik"></div>
                                <div class="dropdown_text">russian</div>
                            </a></li>
                            <li><a href="#">
                                <div class="language_flag"><img src="{{asset('images')}}/flag_5.svg" alt="https://www.flaticon.com/authors/freepik"></div>
                        ...
                        <div class="col">
                            <div class="products_container grid">
                                ...
                                <div class="product grid-item sale">
                                    <div class="product_inner">
                                        <div class="product_image">
                                            <img src="{{asset('images')}}/product_3.jpg" alt="">
                                ...
                                <div class="product grid-item">
                                    <div class="product_inner">
                                        <div class="product_image">
                                            <img src="{{asset('images')}}/product_4.jpg" alt="">
                                        </div>
                                        <div class="product_content text-center">
                                ...
                                <div class="product grid-item">
                                    <div class="product_inner">
                                        <div class="product_image">
                                            <img src="{{asset('images')}}/product_5.jpg" alt="">
                                        </div>
                                        <div class="product_content text-center">
                                            <div class="product_title"><a href="product.html">long red shirt</a></div>
                                ...
                                <div class="product grid-item new">
                                    <div class="product_inner">
                                        <div class="product_image">
                                            <img src="{{asset('images')}}/product_6.jpg" alt="">
                                ...
                                <div class="product grid-item">
                                    <div class="product_inner">
                                        <div class="product_image">
                                            <img src="{{asset('images')}}/product_7.jpg" alt="">
                                        </div>
                                        <div class="product_content text-center">
                                            <div class="product_title"><a href="product.html">long sleeve jacket</a></div>
                                ...
                                <div class="product grid-item sale">
                                    <div class="product_inner">
                                        <div class="product_image">
                                            <img src="{{asset('images')}}/product_8.jpg" alt="">
                                            <div class="product_tag">sale</div>
                                        </div>
                                        <div class="product_content text-center">
                                            <div class="product_title"><a href="product.html">denim men shirt</a></div>
